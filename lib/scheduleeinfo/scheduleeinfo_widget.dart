...
class ScheduleeinfoWidget extends StatefulWidget {
  const ScheduleeinfoWidget({Key? key}) : super(key: key);

  @override
  _ScheduleeinfoWidgetState createState() => _ScheduleeinfoWidgetState();
}

class _ScheduleeinfoWidgetState extends State<ScheduleeinfoWidget> {
